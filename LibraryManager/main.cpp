...
void sqlConnection()
{
    ...
    query.exec(QString::fromUtf8("INSERT INTO userInfo VALUES('123456', '123456')"));
     ...
     */
    // 创建个人中心表
    query.exec(QString::fromUtf8("CREATE TABLE IF NOT EXISTS personalCenter(借出时间 DATATIME, 还书时间 DATATIME, 编号 INT, 账号 VARCHAR(20))"));
}
